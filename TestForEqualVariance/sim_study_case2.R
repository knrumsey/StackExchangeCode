...
# ==================================
# CASE TWO - Roughly equal variances
# ==================================
# Simulate parameters
n1 <- 100
mu1    <- 0
sigma1 <- 1
trunc1 <- c(-1.07265, 1.07265)
...
ord <- order(p1)
png("TestForEqualVariance/figs/case2.png", height=5, width=5, units="in", res=300)
plot(p1[ord], type='l', lty=1, col='dodgerblue',
     main="Case 2", ylab="p-value", xlab="Simulation #")
